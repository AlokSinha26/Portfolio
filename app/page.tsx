...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight">{"Hi, I'm Alok Sinha"}</h1>
    </main>
  )
}
